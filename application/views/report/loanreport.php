...
<div class="container-fluid">
                ...
                <tr>
                    <td style="width: 60%;font-size: 20px;" class="text-center">
                        <span id="center-text">
                            ...
                            <div>For the Period <?php echo $_GET['from'] and $_GET['to'] ; ?></div>
    ...
    <div>
        <div class="row">
            <div class="col-12">
                <h4 class="text-center">Loan Report for the date of <?php echo date("F d Y",strtotime($_GET['from'])).' and '.date("F d Y",strtotime($_GET['to'])) ; ?> </h4>
            </div>
        </div>
